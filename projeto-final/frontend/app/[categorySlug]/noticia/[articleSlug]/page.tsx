...
export const fetchArticles = async (slug: string) => {
...
async function Noticia({ params: { categorySlug, articleSlug } }: PageProps) {
  try {
    const noticia = await fetchArticles(articleSlug);
